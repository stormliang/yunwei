...
(function (a, b) {
    ...
    function L(a) {
        var b, c, d, e, g, h, i, j, k, l, m, n, o, p = [], q = [],
    ...
    function m(a, c, d) {
        var e = c + "defer", g = c + "queue", h = c + "mark",
            i = f.data(a, e, b, !0);
    ...
    var c = a.document, d = a.navigator, e = a.location, f = function () {
            ...
            var e = function (a, b) {
                ...
                i = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, j = /\S/,
                k = /^\s+/, l = /\s+$/, m = /\d/, n = /^<(\w+)\s*\/?>(?:<\/\1>)?$/,
                o = /^[\],:{}\s]*$/, p = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g,
                q = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g,
                r = /(?:^|:|,)(?:\s*\[)+/g, s = /(webkit)[ \/]([\w.]+)/,
                t = /(opera)(?:.*version)?[ \/]([\w.]+)/, u = /(msie) ([\w.]+)/,
                v = /(mozilla)(?:.*? rv:([\w.]+))?/, w = /-([a-z]|[0-9])/ig,
                x = /^-ms-/, y = function (a, b) {
                    return (b + "").toUpperCase()
                }, z = d.userAgent, A, B, C, D = Object.prototype.toString,
                E = Object.prototype.hasOwnProperty, F = Array.prototype.push,
                G = Array.prototype.slice, H = String.prototype.trim,
                I = Array.prototype.indexOf, J = {};
            e.fn = e.prototype = {
    ...
    f.extend({
        ...
        var a = c.createElement("div"), b = c.documentElement, d, e, g, h, i, j,
    ...
    f.extend({
        ...
        data: function (a, c, d, e) {
            if (!!f.acceptData(a)) {
                var g, h, i = f.expando, j = typeof c == "string",
                    k = a.nodeType, l = k ? f.cache : a,
        ...
        removeData: function (a, b, c) {
            if (!!f.acceptData(a)) {
                var d, e = f.expando, g = a.nodeType, h = g ? f.cache : a,
        ...
        queue: function (a, c) {
            ...
            var d = f.Deferred(), e = this, g = e.length, h = 1,
                i = a + "defer", j = a + "queue", k = a + "mark", l;
    ...
    f.fn.extend({
        ...
        valHooks: {
            option: {
                ...
                get: function (a) {
                    var b, c = a.selectedIndex, d = [], e = a.options,
                        g = a.type === "select-one";
                    if (c < 0) return null;
    ...
    var w = /\.(.*)$/, x = /^(?:textarea|input|select)$/i, y = /\./g, z = / /g,
        A = /[^\w\s.|`]/g, B = function (a) {
            return a.replace(A, "\\$&")
        };
    f.event = {
        ...
        remove: function (a, c, d, e) {
            if (a.nodeType !== 3 && a.nodeType !== 8) {
                d === !1 && (d = C);
                var g, h, i, j, k = 0, l, m, n, o, p, q, r,
                    s = f.hasData(a) && f._data(a), t = s && s.events;
                if (!s || !t) return;
        ...
        fix: function (a) {
            ...
            if (a.pageX == null && a.clientX != null) {
                var h = a.target.ownerDocument || c, i = h.documentElement,
                    j = h.body;
    ...
    f.each(["live", "die"], function (a, c) {
        f.fn[c] = function (a, d, e, g) {
            var h, i = 0, j, k, l, m = g || this.selector,
        ...
        var a = /((?:\((?:\([^()]+\)|[^()]+)+\)|\[(?:\[[^\[\]]*\]|['"][^'"]*['"]|[^\[\]'"]+)+\]|\\.|[^ >+~,(\[\\]+)+|[>+~])(\s*,\s*)?((?:.|\r|\n)*)/g,
            d = 0, e = Object.prototype.toString, g = !1, h = !0, i = /\\/g,
            j = /\W/;
        [0, 0].sort(function () {
            h = !1;
            return 0
        ...
        var l = k.selectors = {
            ...
            relative: {
                "+": function (a, b) {
                    var c = typeof b == "string", d = c && !j.test(b),
                        e = c && !d;
                    d && (b = b.toLowerCase());
                ...
                k = function (b, e, f, g) {
                    ...
                    if (!g && !k.isXML(e)) {
                        ...
                        if (e.nodeType === 9) {
                            ...
                            var m = e, n = e.getAttribute("id"), o = n || d,
                                q = e.parentNode, r = /^\s*[+~]/.test(b);
    ...
    var N = /Until$/, O = /^(?:parents|prevUntil|prevAll)/, P = /,/,
        Q = /^.[^:#\[\.,]*$/, R = Array.prototype.slice, S = f.expr.match.POS,
    ...
    var W = / jQuery\d+="(?:\d+|null)"/g, X = /^\s+/,
        ...
        bb = /checked\s*(?:[^=]|=\s*.checked.)/i, bc = /\/(java|ecma)script/i,
        bd = /^\s*<!(?:\[CDATA\[|\-\-)/, be = {
    ...
    be.optgroup = be.option, be.tbody = be.tfoot = be.colgroup = be.caption = be.thead, be.th = be.td, f.support.htmlSerialize || (be._default = [1, "div<div>", "</div>"]), f.fn.extend({
        ...
        clone: function (a, b, c) {
            ...
            var b, c, d = f.cache, e = f.expando, g = f.event.special,
    ...
    var bm = /alpha\([^)]*\)/i, bn = /opacity=([^)]*)/, bo = /([A-Z]|^ms)/g,
        bp = /^-?\d+(?:px)?$/i, bq = /^-?\d/, br = /^([\-+])=([\-+.\de]+)/,
    ...
    f.fn.css = function (a, c) {
        ...
        var c, d = a.currentStyle && a.currentStyle[b],
            e = a.runtimeStyle && a.runtimeStyle[b], f = a.style;
    ...
    var bz = /%20/g, bA = /\[\]$/, bB = /\r?\n/g, bC = /#.*$/,
        ...
        bK = /^(?:select|textarea)/i, bL = /\s+/, bM = /([?&])_=[^&]*/,
        bN = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, bO = f.fn.load,
        bP = {}, bQ = {}, bR, bS, bT = ["*/"] + ["*"];
    try {
        bR = e.href
    ...
    bS = bN.exec(bR.toLowerCase()) || [], f.fn.extend({
        ...
        ajax: function (a, c) {
            ...
            var d = f.ajaxSetup({}, c), e = d.context || d,
                ...
                h = f.Deferred(), i = f._Deferred(), j = d.statusCode || {}, k,
                l = {}, m = {}, n, o, p, q, r, s = 0, t, u, v = {
    ...
    f.fn.extend({
        show: function (a, b, c) {
            ...
            return this[e.queue === !1 ? "each" : "queue"](function () {
                ...
                var b = f.extend({}, e), c = this.nodeType === 1,
                    d = c && f(this).is(":hidden"), g, h, i, j, k, l, m, n, o;
    ...
    "getBoundingClientRect" in c.documentElement ? f.fn.offset = function (a) {
        ...
        var h = e.body, i = cu(e), j = g.clientTop || h.clientTop || 0,
        ...
        if (b === b.ownerDocument.body) return f.offset.bodyOffset(b);
        f.offset.initialize();
        var c, d = b.offsetParent, e = b, g = b.ownerDocument,
            h = g.documentElement, i = g.body, j = g.defaultView,
            k = j ? j.getComputedStyle(b, null) : b.currentStyle,
            l = b.offsetTop, m = b.offsetLeft;
        ...
        initialize: function () {
            var a = c.body, b = c.createElement("div"), d, e, g, h,
            ...
            var e = f(a), g = e.offset(), h = f.css(a, "top"),
                i = f.css(a, "left"),
